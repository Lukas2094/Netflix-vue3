...
<template>
    <div class="fixed w-full h-screen bg-black">
       <div v-if="!showFullVideo" id="Sidenav" class="flex z-40 items-center w-[120px] h-screen">
           <img class="absolute top-0 w-[35px] mt-10 ml-10 z-50" src="/images/netflix-logo.png" alt="netflix-logo">
           <div class="z-50">
       ...
       <div v-if="!showFullVideo">
          <div class="fixed flex z-20 top-0 right-0 w-full h-[50%] bg-black pl-[120px] bg-clip-border">
            <div class="absolute z-30 h-[600] left-[120px] w-[77%] right-0 top-0 bg-gradient-to-r from-black via-black"/>
       ...
       <div v-if="showFullVideo">
           ...
           loop
           controls
           class="absolute z-10 w-[100vw] h-full object-fit"
